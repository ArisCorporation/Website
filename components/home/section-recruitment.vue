...
<template>
  ...
  <TheModal ref="modal" hide-close-button hide-x-button>
    <template #content="{ closeAction }">
      <div class="text-left">
        <div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              spielen haben, und dein Interesse sollte darin bestehen jegliche Situation ruhig zu klären und nicht
              direkt den Abzug zu betätigen.
            </li>
            <li>
