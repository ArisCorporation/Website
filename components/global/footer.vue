			...
			<div class="flex flex-wrap justify-center xl:justify-between xl:flex-nowrap">
				<div class="flex flex-col justify-between w-full xl:w-2/3">
					<div class="">
						<template v-if="footer">
							<p v-if="footerLang === 'de'" class="italic">
								{{de}}
							</p>
							<p v-if="footerLang === 'en'" class="italic">
								{{en}}
							</p>
						</template>
						<template v-else>
					...
					<p class="*:after:content-['_-_'] *:after:text-tbase">
						...
						<span><NuxtLink
							to="/credits"
							class="hover:brightness-85 animate-link"
						>Credits</NuxtLink></span>
						<span><NuxtLink
							to="/bug-report"
							class="hover:brightness-85 animate-link"
						>Bug-Report Tool</NuxtLink></span>
						<span><NuxtLink
							to="/ams"
							class="hover:brightness-85 animate-link"
						>A.M.S.</NuxtLink></span>
				...
				<div class="flex flex-col justify-between w-full xl:w-1/3">
					...
					<div class="flex mx-auto mt-auto space-x-2 xl:mt-4 w-fit">
						...
						<div class="footer-icon">
							<NuxtLink
								aria-label="Die Website von RSI"
								to="https://robertsspaceindustries.com/"
								target="_blank"
							>
								<Icon
									name="IconsLogosRsi"
						...
						<div class="footer-icon">
							<NuxtLink
								aria-label="Die Website von CIG"
								to="https://cloudimperiumgames.com/"
								target="_blank"
							>
								<Icon
									name="IconsLogosCig"
