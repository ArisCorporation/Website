...
<template>
  ...
  >
    <template v-for="member in data.value" :key="member.id">
      <div
        class="aspect-[270/320] text-center relative max-w-[270px] w-full mx-auto bg-image group"
      >
        <div class="absolute flex w-full h-full">
          <div
            class="z-20 m-auto opacity-0 group-hover:opacity-100 transition-short-group"
          >
            <hr />
            <p class="m-0">
              Position:
        ...
        <div
          class="absolute w-full h-full bg-black opacity-0 group-hover:opacity-50 transition-short-group z-10"
        />
        <NuxtImg
          :src="member.potrait || '0b7eafde-0933-4d1a-a32f-b4f8dd5bb492'"
