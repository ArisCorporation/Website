...
<template>
	<div class="static block px-2 pb-3 basis-full md:basis-1/2 xl:basis-1/3 3xl:basis-1/4">
		<DefaultPanel
			:color="color"
			:class="{ 'animate-link': !displayCrud }"
		>
			<div class="relative h-fit">
				...
				>
					...
					>
						...
						<p
							v-if="displayLoanerState && hangarData.loaner"
				...
				>
					...
					<div
						v-if="displayCrud"
						class="absolute z-20 block h-full mt-auto ml-auto right-4"
					>
				...
				>
					<div class="grid grid-cols-6 px-4 py-2 text-xs uppercase">
						<TableRow
							...
							:content="shipData.classification"
						/>
						<TableRow
							title="Crew"
						...
						<TableRow
							title="Kaufpreis"
							:content="shipData.price && shipData.price + ' aUEC'"
						/>
						<TableRow
							title="Fracht"
							:content="shipData.cargo"
						/>
						<TableHr />
						<TableRow
							title="Länge"
							:content="shipData.length && shipData.length + ' M'"
							third
						/>
						<TableRow
							title="Breite"
							:content="shipData.beam && shipData.beam + ' M'"
							third
						/>
						<TableRow
							title="Höhe"
							:content="shipData.height && shipData.height + ' M'"
							third
						/>
						<template v-if="hangarData">
							...
							<TableRow
								title="Aktives Modul"
								:content="hangarData.userData.module?.name"
								full-width
							/>
						</template>
					</div>
