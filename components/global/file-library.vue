...
<template>
  <div class="flex flex-row max-w-full">
    <div class="min-w-72">
      <ul class="space-y-4 list-none">
        <li class="p-0">
          ...
          >
            <div class="flex my-auto space-x-1 w-fit" @click="active_folder = null">
        ...
        <li class="p-0">
          ...
          >
            <div
              class="flex my-auto space-x-1 w-fit"
    ...
    <div class="flex-grow w-auto h-full p-4 border rounded border-bsecondary">
