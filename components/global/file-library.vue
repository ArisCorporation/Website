...
<template>
  <div
    class="w-full max-w-full grid-cols-3 border divide-y rounded indic sm:divide-x sm:divide-y-0 sm:grid border-bsecondary divide-bsecondary"
  >
    <div class="px-1 pb-4 overflow-auto sm:pb-0 max-h-[calc(100vh_-_6rem)] py-2">
    ...
    <div
      class="w-auto col-span-2 p-4 mx-2 overflow-y-auto sm:mr-0 min-h-max max-h-[calc(100vh_-_6rem)] py-2"
    >
      <div
        class="grid gap-4"
