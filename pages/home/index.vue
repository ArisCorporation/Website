    ...
    directus.request(
      readItems('departments', {
        fields: [
          ...
          'description',
          'primary_employees.id',
          'primary_employees.first_name',
          'primary_employees.last_name',
          'primary_employees.title',
          'primary_employees.slug',
          'primary_employees.avatar',
          'primary_employees.head_of_department',
          'secondary_employees.id',
          'secondary_employees.first_name',
          'secondary_employees.last_name',
          'secondary_employees.title',
          'secondary_employees.slug',
          'secondary_employees.avatar',
        ],
        sort: ['name'],
      }),
    ),
