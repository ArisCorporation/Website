		...
		>
			...
			<template #tabcontent>
				...
				<template v-if="selectedTab === 1">
					<Editor
						:model-value="data.history_introduction"
						read-only
					/>
					...
					<h2 class="text-center">
						<span class="text-aris-400">{{ data.history[historyIndex].year }}</span>{{ data.history[historyIndex].title ? ': ' + data.history[historyIndex].title : '' }}
					</h2>
