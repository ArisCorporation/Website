		...
		<template #modalContent>
			<template v-if="modalData.type === 'star'">
				...
				<div class="min-h-[120px]">
					<TableParent
						title="Infobox"
						class="float-right w-full mt-6 mb-8 xl:ml-12 xl:float-right xl:w-1/2"
					>
						<TableRow
							title="Typ"
							:content="modalData.data.type"
						/>
						<TableRow
							title="Größe"
							:content="modalData.data.size"
						/>
					</TableParent>
					<Editor
						:model-value="modalData.data.content"
						read-only
					/>
				</div>
			</template>
			<template v-else-if="modalData.type === 'planet' || modalData.type === 'moon'">
				...
				<div class="min-h-[520px]">
					...
					>
						...
						<TableRow
							title="Alter"
							:content="modalData.data.age"
						/>
						<TableRow
							title="Orbitale Umlaufzeit"
							:content="modalData.data.orbital_period"
						/>
						<TableRow
							title="Distanz"
							:content="modalData.data.distance"
						/>
						<TableRow
							title="Typ"
							:content="modalData.data.type"
						...
						<TableRow
							title="Habitabel"
							:content="modalData.data.habitable ? 'Ja' : 'Nein'"
						/>
						<TableRow
							title="Fairchanceact aktiv"
							:content="modalData.data.fairchanceact ? 'Ja' : 'Nein'"
						/>
						<TableRow
							title="Bevölkerung"
						...
						<TableRow
							title="Wirtschaft"
							:content="modalData.data.economy ? modalData.data.economy + ' / 10' : ''"
						/>
						<TableRow
							title="Gefahrenstufe"
