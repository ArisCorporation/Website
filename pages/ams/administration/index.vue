      ...
      <div v-if="modalStore.type === 'userCreationSuccess'">
        ...
        <table class="prose prose-invert">
          <tbody>
            ...
            <tr v-if="modalStore.data?.lastname" class="border-aris-400">
              <td>Nachname:</td>
      ...
      <div class="flex-1">
        ...
        >
          <UCard class="flex flex-col flex-1 h-screen scrollbar-gray-thin">
            ...
            <h4 class="mt-0 mb-1 text-left">Basisdaten {{ userFormData.email }}</h4>
            <div class="items-center justify-between space-y-6 gap-x-4">
              <ArisUFormGroup required size="xl" label="Vorname" name="firstname">
              ...
              <ArisUFormGroup size="xl" label="Nachname" name="lastname">
              ...
              <ArisUFormGroup size="xl" label="Titel" name="title">
                <div class="relative">
                  <USelectMenu
              ...
              <ArisUFormGroup size="xl" label="Passwort" name="password">
              ...
              <ArisUFormGroup required size="xl" label="Position" name="role">
                <div class="relative">
                  <USelectMenu
                ...
                <template #help>
                  <span v-if="userFormData?.role?.id === '767bb09e-a6fc-4ebb-8c5f-08b060ab0bdb'" class="text-danger">
