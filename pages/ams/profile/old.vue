...
// const { user: userData } = useDirectusAuth();
const user = {};
const { readUser } = useDirectusUsers();
...
const checkboxRecruitment = ref(true);
const checkboxMarketing = ref(false);
const checkboxCW = ref(false);
...
const formData = reactive({
  ...
  dutyPeriod: '',
  dutyEnd: '',
  dutyDivision: { name: 'UEE Navy', value: 'navy' },
  educationName: '',
  educationPeriod: '',
  educationPlace: null,
  hobbies: '',
...
//             path: 'customErrors',
//             message:
//               'Es gab ein Problem dabei deine Daten zu aktualisieren. Wende dich für Hilfe bitte an das Administrations-Team. (@thomas_blakeney, @decon_vorn)',
//           },
//         ]);
//       }
//     }
...
<template>
  <NuxtLayout name="ams">
    ...
    <div class="relative flex items-center p-5 mb-5 rounded-lg bg-bsecondary">
      ...
      >
        <!-- <NuxtImg :src="user?.potrait" :placeholder="[16, 16, 1, 5]" class="z-10 object-cover w-full h-full" /> -->
