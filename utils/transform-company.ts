    ...
    ...(obj.headquarter && {
      headquarter: {
        ...
        ...(obj.headquarter[0].collection === 'planets' && {
          planet: { name: obj.headquarter[0].headquarter.name, slug: obj.headquarter[0].headquarter.slug },
        }),
        ...(obj.headquarter[0].collection === 'moons' && {
          moon: { name: obj.headquarter[0].headquarter.name, slug: obj.headquarter[0].headquarter.slug },
        }),
