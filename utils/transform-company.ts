  ...
  return {
    ...
    ...(obj.headquarter && {
      headquarter: {
        ...
        ...(obj.headquarter[0].collection === 'planets' && { planet: transformPlanet(obj.headquarter[0].headquarter) }),
        ...(obj.headquarter[0].collection === 'moons' && { moon: transformMoon(obj.headquarter[0].headquarter) }),
        ...(obj.headquarter[0].collection === 'landing_zones' && transformLandingZone(obj.headquarter[0].headquarter)),
