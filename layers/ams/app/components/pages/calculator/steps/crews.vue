...
import type { CalculatorUserOption, Ship } from '~~/types'

defineProps<{ users: CalculatorUserOption[]; ships: Ship[] }>()
</script>
  ...
  <div class="space-y-4">
    ...
    >
      <template #description>
        <p className="text-xs text-(--ui-text-muted) mt-1 flex items-center">
